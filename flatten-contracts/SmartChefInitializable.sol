...
// File: contracts\Interface8\IERC20Metadata.sol
...
// File: contracts\Lib8\ReentrancyGuard.sol
...
// File: contracts\Lib8\SafeMath.sol
...
// File: contracts\Interface8\IBEP20.sol
...
contract SmartChefInitializable is Ownable, Referral, ReentrancyGuard {
    ...
    function pendingReward(address _user) external view returns (uint256) {
        ...
        if (block.number > lastRewardBlock && stakedTokenSupply != 0) {
            ...
            uint256 odcReward = multiplier * rewardPerBlock;
            uint256 adjustedTokenPerShare = accTokenPerShare + (odcReward * PRECISION_FACTOR) / stakedTokenSupply;
    ...
    function _updatePool() internal {
        ...
        uint256 multiplier = _getMultiplier(lastRewardBlock, block.number);
        uint256 odcReward = multiplier * rewardPerBlock;
        accTokenPerShare = accTokenPerShare + (odcReward * PRECISION_FACTOR) / stakedTokenSupply;
        lastRewardBlock = block.number;
    }
